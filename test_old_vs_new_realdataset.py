...
from qiskit_algorithms import EstimationProblem, AmplitudeEstimation, FasterAmplitudeEstimation
...
def test_real():
    ...
    with open("results/final_result.txt", "a") as result_file:
